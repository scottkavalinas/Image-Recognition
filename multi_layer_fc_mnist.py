...
epoch =12   # amount of training iterations before testing
...
class FullyConnectedNet(nn.Module):
  def __init__(self):
    ...
    self.FC_Layer_1 = nn.Linear(28*28, 2500) # 28x28 pixels in, 10 labels out
    self.FC_Layer_2 = nn.Linear(2500, 1500)
    self.FC_Layer_3 = nn.Linear(1500, 512)
    self.FC_Layer_4 = nn.Linear(512, 128)
    self.FC_Layer_5 = nn.Linear(128, 10)
