...
Batch_size = 256 # train in batches
epoch =1 
net_list =[1,2,3]
...
class ConvNet_2(nn.Module):
  def __init__(self):
    ...
    self.CONV_Layer_1 = nn.Conv2d(in_channels = 1, out_channels=80,        
                                  kernel_size= 4, stride=1, padding=0)
    self.CONV_Layer_2 = nn.Conv2d(in_channels = 20, out_channels=30,        
                                  kernel_size= 5, stride=1, padding=0)  
    # 28-4+1=25 -> 25-5+1 = 21
    self.FC_Layer_1 = nn.Linear(21*21*30,10)
...
class ConvNet_3(nn.Module):
  def __init__(self):
    ...
    self.CONV_Layer_1 = nn.Conv2d(in_channels = 1, out_channels=10,        
                                  kernel_size= 5, stride=1, padding=0)
    self.CONV_Layer_2 = nn.Conv2d(in_channels = 20, out_channels=10,        
                                  kernel_size= 4, stride=1, padding=0)
    self.CONV_Layer_3 = nn.Conv2d(in_channels = 1, out_channels=10,        
                                  kernel_size= 3, stride=1, padding=0)
    
    # 28-4+1=25 -> 25-5+1 = 21  -> 21-6+1 = 16
    self.FC_Layer_1 = nn.Linear(17*17*4,10)
...
def run(net_choice):
  ...
  if net_choice == 2:
    conv_connected_EX = ConvNet_2().to(device)
  if net_choice == 3:
    conv_connected_EX = ConvNet_3().to(device)
